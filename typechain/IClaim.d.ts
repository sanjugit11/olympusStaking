...
interface IClaimInterface extends ethers.utils.Interface {
  functions: {
...
export class IClaim extends BaseContract {
  ...
  estimateGas: {
    terms(_address: string, overrides?: CallOverrides): Promise<BigNumber>;
  };
